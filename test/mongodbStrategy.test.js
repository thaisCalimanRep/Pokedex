...
//     const { nome, height, weight, types, abilities, viewed } =
//       await context.create(MOCK_POKEMON_CADASTRAR);
//     assert.deepEqual(
//       { nome, height, weight, types, abilities, viewed },
//       MOCK_POKEMON_CADASTRAR
//     );
//   });
});
